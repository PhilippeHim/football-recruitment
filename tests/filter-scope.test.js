...
test('Le résumé du périmètre décrit les filtres actifs', () => {
  assert.equal(
    ...
    'Tous postes · Tous championnats · Toutes nationalités · Hommes et femmes · OVR ≥ 75',
  );
  assert.equal(
    filterScope({
      ...RESET_FILTERS,
    ...
    'Défenseur central · 3 championnats · France · Hommes · Hors 5 grands masculins · DEF ≥ 75 · Passes courtes ≥ 70 · Recherche : psg',
  );
});
